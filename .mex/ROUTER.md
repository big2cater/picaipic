...
- **Scan profiling (2026-07-27):** local `D:\100k` all-JPEG `AFile::new` reference: 10k and 100k both **43.7 files/sec**, 0 failures. Full scans can enable `PICAIPIC_SCAN_PHASE_PROFILE=1` for count/traversal/index/drain/thumb/embed/finalize timings. Protocol: `docs/guide/library-scan-profiling.md`, `patterns/profile-library-scan.md`.
