...
- **Scan profiling (2026-07-27):** `D:\100k` all-JPEG: `AFile::new` 43.7 files/sec at 10k/100k; serial temporary-DB + 200px thumbnail fixture 22.0 files/sec at 10k, 0 failures, 51.6% index / 48.4% thumb. Production worker can enable `PICAIPIC_SCAN_PHASE_PROFILE=1`. Protocol: `docs/guide/library-scan-profiling.md`, `patterns/profile-library-scan.md`.
