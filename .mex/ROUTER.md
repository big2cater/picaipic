...
**Working:**
- **Cyberpunk idle glitch (2026-07-26):** theme menu **Default / Retro / CMYK / Black hole / Cyberpunk** (`THEME_ID.CYBERPUNK=4`); dual-pin + dark pin; Home `cpFxActive` (mirrors BH seven-way gate) → `cpGlitchActive`; maximize + 6s idle → photo-area `PhotoGlitchLayer` continuous glitch until activity; intensity gated in GridView (`>0`). Pattern `patterns/change-cyberpunk-theme.md`; spec `docs/superpowers/specs/2026-07-26-cyberpunk-idle-glitch-design.md`.
...
| Change cyberpunk theme, neon chrome, idle photo glitch, intensity gate | `patterns/change-cyberpunk-theme.md` then `docs/superpowers/specs/2026-07-26-cyberpunk-idle-glitch-design.md` |
