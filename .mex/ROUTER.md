...
- **Scan profiling (2026-07-27):** `D:\100k` all-JPEG: `AFile::new` 43.7 files/sec; serial temp-DB + 200px thumb 22.0 files/sec. AI-enabled production scan: 9,548.281s total, 3,233.415s traversal + 6,313.095s drain, identifying single-permit embedding as the dominant tail. Task timers now exclude semaphore waits; per-file embed success logs are opt-in. Protocol: `docs/guide/library-scan-profiling.md`, `patterns/profile-library-scan.md`.
