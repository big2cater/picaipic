...
## When to use
- Theme menu Default / Retro / CMYK / Black hole
...
|-------|----------|-------|
| Theme ids | `utils.ts` `THEME_ID`, `setTheme`, `isBlackHoleTheme` | Black hole pins `data-theme=dark` |
...
| **Photo effect** | `PhotoVortexLayer.vue` + `GridView.vue` | Freeze visible thumbs → UV spiral lens; hide grid after capture |
...
- Superseded plan: `docs/superpowers/plans/2026-07-25-black-hole-idle-theme.md` (v1.3)

## Verify
- Theme switch off black hole: cosmos unmounts, no residual transforms/opacity on cards
