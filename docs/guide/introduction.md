...
**PicAiPic** is a local-first photo manager built for people who want fast browsing, practical organization tools, and private on-device search.
...
PicAiPic is designed to avoid that compromise.
...
PicAiPic is currently available for Linux and Windows.
...
- [Check out what's new in v1.1.0](/guide/release-notes/v1.1.0)
