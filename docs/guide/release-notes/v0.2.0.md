# Release Notes - PicAiPic v0.2.0

PicAiPic v0.2.0 is a major under-the-hood update focused on database efficiency and indexing performance, with broad new video format support across all platforms.
...
Many thanks to everyone who reported issues, tested preview builds, and helped improve PicAiPic across macOS, Windows, and Linux.
