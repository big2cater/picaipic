# Release Notes - PicAiPic v0.2.1

PicAiPic v0.2.1 focuses on broader platform support, faster thumbnail loading, better image format coverage, and safer library maintenance tools.
