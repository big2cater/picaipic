# Release Notes - PicAiPic v0.2.2

PicAiPic v0.2.2 brings drag-and-drop file import, richer RAW metadata extraction, AI-powered multilingual image search, and a new masonry grid layout.
