...
echo.
echo SA-LUT plugin runtime dependencies are installed and verified.
echo Profile setup finished. Run Smoke in PicAiPic before using this profile.
echo Use .local.env for local development overrides such as SALUT_SOURCE_DIR,
echo SALUT_MODEL_DIR, or PICAIPIC_SALUT_PYTHON.
exit /b 0
