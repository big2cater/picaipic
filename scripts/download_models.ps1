...
# Product default text tower: CLIP-B/32-aligned bilingual int8 (EN+CN), self-hosted.
# Observation: legacy EN-only CLIP text kept as commented URLs (do not delete yet).
#   EN text: https://huggingface.co/Xenova/clip-vit-base-patch32/resolve/main/onnx/text_model_quantized.onnx
#   EN tok:  https://huggingface.co/openai/clip-vit-base-patch32/resolve/main/tokenizer.json
$Models = @(
    @{ Url = "https://github.com/big2cater/picaipic-binaries/releases/download/models/clip-vit-b32-multilingual-v1-text-tokenizer.json"; File = "tokenizer.json" },
    @{ Url = "https://github.com/big2cater/picaipic-binaries/releases/download/models/clip-vit-b32-multilingual-v1-text-int8.onnx"; File = "text_model.onnx" },
