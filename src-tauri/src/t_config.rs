...
pub fn get_plugin_store_dir_config() -> Result<Option<String>, String> {
    Ok(load_app_config()?.plugin_store_dir)
}

pub fn set_plugin_store_dir_config(path: Option<String>) -> Result<(), String> {
    let mut config = load_app_config()?;
    config.plugin_store_dir = path;
